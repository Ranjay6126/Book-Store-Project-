  ...
  return (
    <header className="animate-fade-in relative z-30 shrink-0 border-b border-[#d9ded3] bg-[#fffdf8]/90 shadow-sm backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-4">
        <span aria-hidden="true" className="hidden grid h-10 w-10 shrink-0 place-items-center rounded-lg border border-[#759971] bg-[#c7dfc0] text-2xl text-black sm:grid"><PiBooksLight /></span>
